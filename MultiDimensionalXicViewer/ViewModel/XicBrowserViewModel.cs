...
namespace MultiDimensionalXicViewer.ViewModel
{
	...
	{
		public double CurrentMz { get; set; }
		public double CurrentTolerance { get; set; }
		public DataReader.FrameType CurrentFrameType { get; set; }
		...
		public XicBrowserViewModel()
		{
			...
			this.CurrentFrameType = DataReader.FrameType.MS1;
		}
		...
		{
			List<IntensityPoint> uimfPointList = this.UimfUtil.GetXic(this.CurrentMz, this.CurrentTolerance, this.CurrentFrameType, DataReader.ToleranceType.PPM);
